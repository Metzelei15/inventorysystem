...
<body>
    <ul>
		...
		<li><a href="?section=Accounts" class="<?= isset($_GET['section']) && $_GET['section'] === 'Accounts' ? 'active' : '' ?>">Accounts</a></li>
    ...
    <div id="content">
        ...
        if (isset($_GET['section'])) {
            switch ($_GET['section']) {
				...
				case 'Accounts':
					echo "<button onClick='goToaccountpage()'>";
    ...
    <script>
		...
		function goToaccountpage(){
			document.location.href = "accountpage.php";
		}
	</script>
</body>
</html>
